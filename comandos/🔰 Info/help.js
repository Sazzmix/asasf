        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.EmbedBuilder()
                    ...
                    .setFooter({ text: `© desarrollado por Sazzmix | 2022`, iconURL: `https://cdn.discordapp.com/avatars/282942681980862474/7ff4f4ae92af5feb0d258a71cdb0b060.png?size=4096` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en desarrollo por \`Sazzmix#8447\``)
            ...
            .addFields([{name: `📈 **__ESTADÍSTICAS__**`, value: `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 desarrollado por **[Sazzmix#8447](https://discord.gg/Hx4DHBJMfS)**`}], )
            .addFields([{name: `✍ **__SERVER PÚBLICO__**`, value: `[\`Unete a el server oficial!\`](https://discord.gg/r7tt9KWqXA)`}], )
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarrollado por Sazzmix | 2022`, iconURL: `https://cdn.discordapp.com/attachments/1012082920875360398/1012395111000322088/descarga.jpg` })
            ...
            collector.on("collect", async (interaccion) => {
                if (interaccion.isButton()) {
                    ...
                    for (const seleccionado of interaccion.values) {
                        ...
                        .setThumbnail(message.guild.iconURL({ dynamic: true }))
                        .setDescription(comandos_de_categoria.length >= 1 ? `>>> *${comandos_de_categoria.map(comando => `\`${comando.replace(/.js/, "")}\``).join(" - ")}*` : `>>> *Todavía no hay comandos en esta categoría...*`)
                        .setFooter({text: `© desarrollado por Sazzmix#8447 | 2022`, iconURL: `https://cdn.discordapp.com/attachments/1012082920875360398/1012395111000322088/descarga.jpg` })
